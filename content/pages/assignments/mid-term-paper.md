...
2.  You should also engage with (i.e. draw on, cite, quote) at least 3 peer-reviewed scholarly articles related to your topic. One can be drawn from our class readings but the additional ones should come from your independent lit search. If you are unsure of where to find good game studies articles you can check out {{% resource_link "82d25181-24f5-47d9-a376-4464d1a8d4f0" "my resource page" %}}.
3.  You should use the Chicago Manual of Style conventions for {{% resource_link "54fe9337-32f2-4485-87e2-1450f8cd2fdf" "quoting and citing work" %}}.
